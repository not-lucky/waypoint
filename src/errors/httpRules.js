/**
 * @fileoverview Error classification infrastructure and HTTP status code rules.
 * Provides rule primitives, context building, and HTTP/stream/transport classification.
 * @module common/errorClassification/httpRules
 */
 ...
 * @returns {Object}
 */
function attachContextFields(result, ctx) {
